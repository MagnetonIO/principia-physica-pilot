...
$dq\wedge dp$ is $\dot q\,dp-\dot p\,dq$. The two velocity components of $Y$
vanish, so the $dp$ terms drop out, and the two momentum components enter with
the sign reversal carried by $-\dot p\,dq$; this gives the first display.
Differentiating each coefficient and
